...
export default function HomePage() {
  ...
  useEffect(() => {
    // Vérifie si le mode sombre est déjà actif au chargement
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-slate-950 text-slate-900 dark:text-slate-50 flex flex-col font-sans transition-colors duration-300">
      ...
      <main className="flex-1 flex flex-col items-center text-center px-4 pt-32 pb-20 bg-[radial-gradient(ellipse_at_top,_var(--tw-gradient-stops))] from-slate-50 via-white to-white dark:from-slate-900 dark:via-slate-950 dark:to-slate-950 transition-colors duration-300">
        ...
        <div className="bg-white dark:bg-slate-900 p-2 rounded-[2rem] shadow-[0_8px_30px_rgb(0,0,0,0.04)] dark:shadow-[0_8px_30px_rgb(0,0,0,0.3)] border border-slate-100 dark:border-slate-800 flex flex-col md:flex-row gap-2 max-w-3xl w-full transition-all">
          <div className="flex-1 flex items-center px-5 py-3.5 bg-transparent rounded-full focus-within:bg-slate-50 dark:focus-within:bg-slate-800/50 transition">
            ...
            <input type="text" placeholder="Que recherches-tu ?" className="bg-transparent outline-none w-full font-semibold text-slate-900 dark:text-white placeholder-slate-400 dark:placeholder-slate-500" />
          </div>
          ...
          <div className="flex-1 flex items-center px-5 py-3.5 bg-transparent rounded-full focus-within:bg-slate-50 dark:focus-within:bg-slate-800/50 transition">
            ...
            <input type="text" placeholder="Dans quelle ville ?" className="bg-transparent outline-none w-full font-semibold text-slate-900 dark:text-white placeholder-slate-400 dark:placeholder-slate-500" />
          </div>
          <Link href="/alternance" className="bg-blue-600 hover:bg-blue-700 text-white font-bold px-8 py-4 rounded-full transition flex items-center justify-center gap-2 shadow-md">
            Rechercher
          </Link>
        </div>
      </main>
